...
class UsersController extends Controller
{
    ...
    public function index(IndexUser $request)
    {
        ...
        $data = AdminListing::create(User::class)->processRequestAndGet(
            ...
            ['api_token', 'birthday', 'deleted', 'dismissed', 'email', 'first_name', 'id', 'inn', 'passport_number', 'passport_series', 'scan', 'second_name', 'surname'],

            // set columns to searchIn
            ['api_token', 'email', 'first_name', 'id', 'inn', 'passport_number', 'passport_series', 'scan', 'second_name', 'surname']
        );

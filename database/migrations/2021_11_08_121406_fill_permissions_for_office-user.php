...
class FillPermissionsForOfficeUser extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForOfficeUser constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.office-user',
            'admin.office-user.index',
            'admin.office-user.create',
            'admin.office-user.show',
            'admin.office-user.edit',
            'admin.office-user.delete',
            'admin.office-user.bulk-delete',
        ]);

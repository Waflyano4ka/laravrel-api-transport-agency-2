...
class FillPermissionsForPostUser extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPostUser constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.post-user',
            'admin.post-user.index',
            'admin.post-user.create',
            'admin.post-user.show',
            'admin.post-user.edit',
            'admin.post-user.delete',
            'admin.post-user.bulk-delete',
        ]);

...
class FillPermissionsForPassenger extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPassenger constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.passenger',
            'admin.passenger.index',
            'admin.passenger.create',
            'admin.passenger.show',
            'admin.passenger.edit',
            'admin.passenger.delete',
            'admin.passenger.bulk-delete',
        ]);
